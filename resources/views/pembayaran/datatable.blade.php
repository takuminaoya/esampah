            ...
            <tbody>
                @forelse ($pembayarans as $pembayaran)
                    <tr>
                        ...
                        <td>{{ $pembayaran->pembayaran->verifikasi_bendahara == 1 ? 'Lunas' : 'Belum diverifikasi CUB' }}
                        </td>
                        <td>{{ $pembayaran->pembayaran->created_at->isoFormat('D MMMM Y') }}</td>
                        <td>{{ $pembayaran->pembayaran->pegawai_id == null ? 'Admin' : $pembayaran->pembayaran->pegawai->nama }}
                        </td>
                    </tr>
                @empty
                    <tr>
